...
def get_parser():
    ...
    parser.add_argument(
        ...
        choices=["raw_data", "noise_data", "timestep_aware"], 
        help="quantization mode to use"
    )
...
def obtain_calib_data(opt):
    ...
    # TODO: timestep --> laten embedding
        ...
        calib_data = (cali_dataset, random_label)
...
if __name__ == "__main__":
    ...
    if opt.ptq:
        ...
        torch.save(qnn.state_dict(), logdir+'/'+"quante_Unet_w{}a{}_ptq_{}.pt".format(opt.weight_bit, opt.act_bit, opt.ptq))     
